...
import { ArchiveX, Command, File, Inbox, MessageSquareQuote, Send, Trash2 } from "lucide-react";
              ...
              <SidebarMenuButton size="lg" asChild className="md:h-8 md:p-0">
                <div>
                  ...
                  <div className="grid flex-1 text-left text-sm leading-tight">
                    ...
                    <a href="https://github.com/insanXYZ/whatsupp" className="truncate text-xs">insanXYZ</a>
                  </div>
                </div>
              </SidebarMenuButton>
            </SidebarMenuItem>
